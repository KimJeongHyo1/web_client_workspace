 ...
 * - cookie(값을 서버에 전송)/indexeddb(대용량데이터)등과 유사
 ...
 * - Session Storage - 서버접속한 동안 보관(window 닫으면 제거)
 */
document.querySelector("#btn1").onclick = () => {
    // window하위에서 객체별로 관리 (애플리케이션화면에서도 보기가능)
