/**
 * Promise
 * - 비동기작업(producing code) + 콜백(consumingcode)를 명쾌히 작성하는 문법
 * 
 ...
 * - 암묵적으로 Promise객체 반환(반환한 값이 있다면 새Promise의 result값으로 사용된다)
 * - 명시적으로 Promise 객체를 반환할수도 있다
 */
...
/**
 * - changeBGColor : Promise객체를 반환하는 함수만들고 그 안에 비동기작업
 * - then절 (콜백함수)
 */
