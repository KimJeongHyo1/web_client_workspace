$("#btn1").on('click', () => {
    ...
    $("[title]").css('background-color', 'lavender');

    // title속성이 안녕3인 요소 color 변경
    $("[title=안녕3]").css('color', 'orange');
...
$("#btn3").on('click', () => {
    // input[type=text]
    $(":text")
        .css('background-color', 'orange') // 원래 jquery객체를 다시 리턴. 메소드 chaining
        .css('color', 'white');
    ...
    $(":checkbox#baseball, :checkbox#baseball ").prop("checked", true);
...
$(btn4).on('click', () => {
    ...
    // const $selected = $("#people tr:odd"); // 0based index 홀수 : nth-child(2n + 1)
    // const $selected = $("#people tr:even"); // 0based index 짝수 : nth-child(2n)

    // const $selected = $("#people tr:eq(3)"); // 3번지보다 큰
    // const $selected = $("#people tr:gt(0)"); // 0번지
    // const $selected = $("#people tr:lt(3)");  // 3번지보다 작은
